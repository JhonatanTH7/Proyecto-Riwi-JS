...
function alertaNoti(tipoAlerta) {
  ...
  const imagen_box_Alert =
    notification_Emerg.querySelector("#imagen_box_Alert");
  const title_box_Alert_event = notification_Emerg.querySelector(
    "#title_box_Alert_event"
  );
  const notification_Content = notification_Emerg.querySelector(
  ...
  switch (tipoAlerta) {
    case "caution":
      ...
      if (document.querySelector("html").lang == "es") {
        ...
        notification_Content.textContent =
          "Aqui va una descripcion del la alerta";
      } else {
